    ...
    subSolutions: [
      {
        ...
        description: 'The SCADALink is a flexible low power Satellite SCADA device that provides Modem, RTU, and Alarm callout in a single device. It’s designed for remote SCADA communications and monitoring of RS232/RS485 serial devices such Flow Computer, RTU, PLC, Smart Transmitter, and Power Communication. The SAT XXX’s low power draw makes it an ideal solution for many remote SCADA applications'
      },
      {
        title: 'Satellite Alarm Callout Operation',
        description: 'An Alarm Callout system typically involves a server or devices that polls and monitors a sensor or a system for certain conditions. When the server or device detects an anomaly, a Voice, SMS, and/or Email report is sent to a user that signal a problem that might require attention. With the advent of IoT, all alarm callout features are configurable to suit any industrial applications.'
      }
    ]
  },
  {
